...
| [exploring_ot_datasets.ipynb](notebooks/exploring_ot_datasets.ipynb)           | Python   | pyspark, polars, dask  | Explore the Open Targets datasets available at Open Targets Data Downloads. Includes information on diseases, targets, evidence, and associations. | [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/opentargets/notebooks/blob/main/notebooks/exploring_ot_datasets.ipynb)      |
